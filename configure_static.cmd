...
%v% atlmfc qt5-graphicaleffects qt5-location qt5-quickcontrols qt5-quickcontrols2 qt5-serialport qt5-webchannel
if %errorlevel% neq 0 exit /b %errorlevel%
%v% protobuf boost xerces-c xalan-c grpc libzip lua[cpp]
%v% mimalloc[override] sol2 lmdb flatbuffers z3 gmp yices
if %errorlevel% neq 0 exit /b %errorlevel%
