...
ensure_links("share/qt5", "mkspecs")
ensure_links("share/qt5/debug", "debug/doc")
ensure_links("share/qt5/debug", "debug/mkspecs")
ensure_link_full("tools/qt5", "bin")
ensure_link_full("debug/tools/qt5", "debug/bin")
if sys.platform != "win32" and not os.access("tools/protobuf/protoc", os.X_OK):
