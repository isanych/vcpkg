...
ensure_links("bin", "tools/qt5/bin/moc" + exe)
ensure_links("bin", "tools/qt5/bin/qmake" + exe)
ensure_links("bin", "tools/qt5/bin/rcc" + exe)
ensure_links("bin", "tools/qt5/bin/uic" + exe)
