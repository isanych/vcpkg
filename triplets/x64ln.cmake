...
if(IS_LTO)
  set(VCPKG_CXX_FLAGS_RELEASE "-flto -march=native")
  set(VCPKG_C_FLAGS_RELEASE "-flto -march=native")
  set(VCPKG_LINKER_FLAGS_RELEASE "-flto -march=native")
else()
  set(VCPKG_CXX_FLAGS_RELEASE "-march=native")
  set(VCPKG_C_FLAGS_RELEASE "-march=native")
  set(VCPKG_LINKER_FLAGS_RELEASE "-march=native")
endif()
