...
%v% smtpclient-for-qt protobuf hdf5[zlib,tools] boost rapidjson cryptopp xerces-c xalan-c grpc mimalloc[override] quazip libzip lua[cpp] sol2 lmdb flatbuffers z3
if %errorlevel% neq 0 exit /b %errorlevel%
