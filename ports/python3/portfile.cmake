...
if(VCPKG_TARGET_IS_WINDOWS)
    ...
    if(VCPKG_TARGET_IS_WINDOWS)
        find_library(ZLIB_RELEASE NAMES z zlib zs PATHS "${CURRENT_INSTALLED_DIR}/lib" NO_DEFAULT_PATH)
        find_library(ZLIB_DEBUG NAMES z zd zlib zlibd zsd PATHS "${CURRENT_INSTALLED_DIR}/debug/lib" NO_DEFAULT_PATH)
    else()
