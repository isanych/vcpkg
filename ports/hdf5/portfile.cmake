...
function(clean_and_rename suffix)
    set(full_tool "${CURRENT_PACKAGES_DIR}/bin/${tool}${suffix}${VCPKG_TARGET_EXECUTABLE_SUFFIX}")
    if(EXISTS "${full_tool}")
        vcpkg_clean_tool_in_bin("${tool}${suffix}")
        file(RENAME "${full_tool}" "${CURRENT_PACKAGES_DIR}/tools/${PORT}/${tool}${VCPKG_TARGET_EXECUTABLE_SUFFIX}")
    endif()
endfunction()

if(FEATURES MATCHES "tools")
    if(VCPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
        set(TOOL_SUFFIX "-shared")
    else()
        set(TOOL_SUFFIX "-static")
    endif()

    file(MAKE_DIRECTORY "${CURRENT_PACKAGES_DIR}/tools/${PORT}")
    foreach(tool IN ITEMS h5cc h5hlcc h5c++ h5hlc++ h5copy h5diff h5dump h5ls h5stat gif2h5 h52gif h5clear h5debug h5format_convert h5jam h5unjam h5ls h5mkgrp h5repack h5repart h5watch ph5diff h5import)
        clean_and_rename("${TOOL_SUFFIX}")
        clean_and_rename("")
    endforeach()
