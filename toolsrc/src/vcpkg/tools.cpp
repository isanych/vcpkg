...
CMake suite maintained and supported by Kitware (kitware.com/cmake).
                */
            auto f = StringView::find_all_enclosed(rc.output, "cmake3 version ", "\n");
            return StringView::find_exactly_one_enclosed(rc.output, f.size() == 1 ? "cmake3 version " : "cmake version ", "\n").to_string();
        }
    };
